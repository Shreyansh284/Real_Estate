...
@section('master')
<form action="{{ URL::to('/') }}/reghire" method="post" enctype="multipart/form-data" >
             ...
             <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="col-md-6 mb-4">
                      ...
                      <div class="form-outline datepicker">
                        <input type="text" class="form-control" name="experiance" id="exampleDatepicker1"  value="{{ old('experiance') }}"/>
                        <span class="text-danger">
                            @error('experiance')
                            {{ $message }}
                            @enderror
