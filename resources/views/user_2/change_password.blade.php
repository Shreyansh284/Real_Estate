                ...
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="d-flex flex-row align-items-center back"><i
                            ...
                            <a href="edit_profile_u2" style="text-decoration: none">
                    ...
                    <form action="{{ URL::to('/') }}/change_password_u2" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6"><input type="text" class="form-control" placeholder="New Password"
