...
<head>
    ...
    <meta name="description" content="Dancespace">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="h_index"> <i class="menu-icon fa fa-dashboard"></i>Houseier Dashboard </a>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-table"></i><a href="hmanage_tenant">Registered_Tenant</a></li>
                            <li><i class="fa fa-table"></i><a href="hmanage_house_from_houseier">Houses_From_houseier</a></li>
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="user_1/img/about-2.jpg" alt="User Avatar"  height="30rem" >
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="edithouseier"><i class="fa fa-user"></i> My Profile</a>
                            <a class="nav-link" href="hlogout"><i class="fa fa-power-off"></i> Logout</a>
                        </div>
                    </div>
