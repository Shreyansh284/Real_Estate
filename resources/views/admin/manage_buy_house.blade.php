...
<br>
    <div class="offset-sm-8 col-sm-4">
            <div class="row">
                <div class="col">
                    <a href="/admin/reg.php"><button class="btn btn-danger">Add Buy House</button></a>
                </div>
            </div>
        </div>
        <br><br>
 <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Manage Buy House</strong>
                            </div>
                            <div class="card-body">
        ...
        <tr>
            ...
            <td scope="col"><a class="btn btn-warning"
